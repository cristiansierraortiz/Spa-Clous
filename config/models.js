...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  attributes: {
    ...
    // id_cxc: { type: 'number', autoIncrement: true, },
    // id_cxp: { type: 'number', autoIncrement: true, },
    // id_aho: { type: 'number', autoIncrement: true, },
    // id_cie_ing: { type: 'number', autoIncrement: true, },
    // id_cie_egr: { type: 'number', autoIncrement: true, },
    //--------------------------------------------------------------------------
    //  /\   Using MongoDB?
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'JnYlBXgv9WkEu8anWx0/Pkn3J5TnmRmQ9V279XUrPNw='
  },
